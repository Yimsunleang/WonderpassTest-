...
export default function FormDialog(props) {
    ...
    const [workertype, setWorkerType] = React.useState(props.selected);
    ...
    return (
        <div>
            <IconButton aria-label="edit" className={classes.tool} onClick={handleClickOpen} >
                <EditIcon />
            </IconButton>
